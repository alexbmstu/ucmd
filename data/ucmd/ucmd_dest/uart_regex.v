...
//    FBS(10) - small_letter
//    FBS(9) - rvalid
//    FBS(8) - punctuation_finance
//    FBS(7) - punctuation_basic
//    FBS(6) - parentheses
//    FBS(5) - other
//    FBS(4) - number
//    FBS(3) - math_symbol
...
module ucmd_fsm #( 
    parameter ucmd_g             = 5, 
    parameter ucmd_fbs           = 15, 
    parameter ucmd_adr           = 3, 
    parameter ucmd_c             = 10, 
    parameter cmd_c              = 1,
    parameter ucmdRAM_data_w     = 32,
    parameter ucmdRAM_adr_w      = 6,
    parameter ucmdARAM_data_w    = 3,
    ...
    generate 
        if (control_type=="carry4") begin
            ...
            ucmd_carry4 #(.ucmd_g(ucmd_g), .ucmd_adr(ucmd_adr), .ucmd_fbs(ucmd_fbs)) ucmd_carry4_regex_inst (
...
module bitwise_logic_x8_with_carry4 #(parameter data_w = 32) (
  ...
  carry4_chain #(extended_data_w/2) u_carry4_chain_regex (.data_in(f_ext), .carry_in(en), .result(result));
...
module ucmd_carry4 #(parameter ucmd_g = 2, parameter ucmd_adr = 32, parameter ucmd_fbs = 32) (
  ...
  generate
    for (n = 0; n <= ucmd_adr; n = n+1) begin: carry4_chain_gen
		carry4_chain #(extended_ucmd_term_en3_width) u_carry4_chain_regex ( // Используем carry4_chain
...
module top_ucmd_fsm_regex #(    
	...
	//FEEDBACK SIGNALS
	input wire wready,
	input wire whitespace,
	input wire vowel,
	input wire start_stop,
	input wire small_letter,
	input wire rvalid,
	input wire punctuation_finance,
	input wire punctuation_basic,
	input wire parentheses,
	input wire other,
	input wire number,
	input wire math_symbol,
	input wire hex_digit,
	input wire curly_braces,
	input wire capital_letter,
  ...
  output wire                            busy
	...
	assign fbs = {
		...
		capital_letter};
    `endif
	assign wvalid = ucmd[9];
	assign rready = ucmd[8];
	assign putchar7 = ucmd[7];
	assign putchar6 = ucmd[6];
	assign putchar5 = ucmd[5];
	assign putchar4 = ucmd[4];
	assign putchar3 = ucmd[3];
	assign putchar2 = ucmd[2];
	assign putchar1 = ucmd[1];
	assign putchar0 = ucmd[0];
    ...
    ucmd_fsm #(
        ...
        .mcmem_file("uart_regex.mcmem"),
        .adrmem_file("uart_regex.adrmem"),
...
`ifdef chipscope
	...
	assign cmd = vio_port[15:1];
	assign fbs = vio_port[1+15:15+1];
...
SignalExport.triggerChannel<0000><0254>=ucmd_state[2]
SignalExport.triggerChannel<0000><0253>=ucmd_state[1]
SignalExport.triggerChannel<0000><0252>=ucmd_state[0]
SignalExport.triggerChannel<0000><0251>=wvalid
SignalExport.triggerChannel<0000><0250>=rready
SignalExport.triggerChannel<0000><0249>=putchar7
SignalExport.triggerChannel<0000><0248>=putchar6
SignalExport.triggerChannel<0000><0247>=putchar5
SignalExport.triggerChannel<0000><0246>=putchar4
SignalExport.triggerChannel<0000><0245>=putchar3
SignalExport.triggerChannel<0000><0244>=putchar2
SignalExport.triggerChannel<0000><0243>=putchar1
SignalExport.triggerChannel<0000><0242>=putchar0
SignalExport.triggerChannel<0000><0241>=cmd0
SignalExport.triggerChannel<0000><0240>=start
SignalExport.triggerChannel<0000><0239>=wready
SignalExport.triggerChannel<0000><0238>=whitespace
SignalExport.triggerChannel<0000><0237>=vowel
SignalExport.triggerChannel<0000><0236>=start_stop
SignalExport.triggerChannel<0000><0235>=small_letter
SignalExport.triggerChannel<0000><0234>=rvalid
SignalExport.triggerChannel<0000><0233>=punctuation_finance
SignalExport.triggerChannel<0000><0232>=punctuation_basic
SignalExport.triggerChannel<0000><0231>=parentheses
SignalExport.triggerChannel<0000><0230>=other
SignalExport.triggerChannel<0000><0229>=number
SignalExport.triggerChannel<0000><0228>=math_symbol
SignalExport.triggerChannel<0000><0227>=hex_digit
SignalExport.triggerChannel<0000><0226>=curly_braces
SignalExport.triggerChannel<0000><0225>=capital_letter
...
SignalExport.syncOutput<0016>=wready
SignalExport.syncOutput<0015>=whitespace
SignalExport.syncOutput<0014>=vowel
SignalExport.syncOutput<0013>=start_stop
SignalExport.syncOutput<0012>=small_letter
SignalExport.syncOutput<0011>=rvalid
SignalExport.syncOutput<0010>=punctuation_finance
SignalExport.syncOutput<0009>=punctuation_basic
SignalExport.syncOutput<0008>=parentheses
SignalExport.syncOutput<0007>=other
SignalExport.syncOutput<0006>=number
SignalExport.syncOutput<0005>=math_symbol
SignalExport.syncOutput<0004>=hex_digit
SignalExport.syncOutput<0003>=curly_braces
SignalExport.syncOutput<0002>=capital_letter
SignalExport.syncOutput<0001>=cmd0
SignalExport.syncOutput<0000>=start
SignalExport.syncOutputWidth=17
