...
На основе шаблона `data/ucmd/ucmd_src/uart_hello_world.ucmd` необходимо  разработать микропрограмму, выдающую в отдет на символ `+` последовательность латинских букв ФИО студента, разделенные пробелами (например: `Petrov Petr Petrovich`)
